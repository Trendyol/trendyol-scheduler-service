...
public class JobSynchronizeCouchbaseServiceTest {

    @Rule
    public FrozenClock.Rule frozenClockRule = new FrozenClock.Rule();

    @InjectMocks
    private JobSynchronizeCouchbaseService jobSynchronizeCouchbaseService;
    ...
    public void it_should_return_true_when_scheduled_job_is_not_assigned_to_other_instances() {
        ...
        //When
        boolean result = jobSynchronizeCouchbaseService.isAssignableToThisExecution(scheduledJob);
    ...
    public void it_should_return_true_when_future_job_is_not_assigned_to_other_instances() {
        ...
        //when
        boolean result = jobSynchronizeCouchbaseService.isAssignableToThisExecution(futureJob);
